...
- [Connecting a console](Connecting-a-console)
- [Several places](Places)
- [Publishing a website](Publishing-a-website)
- [Charts](Charts)
- [Sending readings on](Sending-readings-on)
- [Weather forecast](Weather-forecast)
- [Sensor checks](Sensor-checks)
- [Alerts](Alerts)
- [Backups](Backups)
...
*Everything below is how it is built. None of it is needed to run a station.*
